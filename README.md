...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/soft-credit-f00d)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/soft-credit-f00d
```

A live public deployment of this template is available at [https://soft-credit-f00d.templates.workers.dev](https://soft-credit-f00d.templates.workers.dev)
